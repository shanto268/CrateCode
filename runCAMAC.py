...
def configureDAQDefaults(h):
    ...
    # runConfiguration["new_tdc_slots_3377"] = (20, )
    # runConfiguration["new_tdc_channels_3377"] = 32
...
def runCAMAC(configModule, maxEvents, maxTimeSec, runNumber, outputFile,
    ...
    # new_tdc_slots_3377 = runConfiguration["new_tdc_slots_3377"]
    # new_tdc_channels_3377 = runConfiguration["new_tdc_channels_3377"]
